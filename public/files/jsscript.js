...
function setpanorama(){
    ...
    "scenes": {
        "prostor": {
		"hfov": 150,"pitch": 0,"yaw": 179,'type': 'equirectangular','panorama': 'files/prostor.JPG','autoLoad':true,'compass':false,'autoRotate': -2,'hotSpots': [{'pitch':-15.25799,'yaw':-5.28,'type': 'info',"cssClass": "custom-hotspot",'text': 'Ulaz','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Ulaz'}},{'pitch':-9.508599,'yaw':-144.48,'type': 'info',"cssClass": "custom-hotspot",'text': 'Pametna tabla','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Pametna tabla'}},{'pitch':-9.066339,'yaw':123.84,'type': 'info',"cssClass": "custom-hotspot",'text': '3D i klasični štampači','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'3D i klasični štampači'}},{'pitch':-3.759214,'yaw':-3.84,'type': 'scene',"cssClass": "custom-hotspot","sceneId": "ulaz",'text': 'Izlaz na ulicu','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Izlaz na ulicu'}}]}
	,

        "ulaz": {
		"hfov": 150,"pitch": 0,"yaw": 179,'type': 'equirectangular','panorama': 'files/ulaz.JPG','autoLoad':true,'compass':false,'autoRotate': -2,'hotSpots': [{'pitch':-9.95086,'yaw':65.28,'type': 'info',"cssClass": "custom-hotspot",'text': 'Ulaz','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Ulaz'}},{'pitch':-3.316953,'yaw':66.72,'type': 'scene',"cssClass": "custom-hotspot",'text': 'Ulaz na 3. sprat u konferencijsku salu',"sceneId": "prostor",'clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Ulaz na 3. sprat u konferencijsku salu'}},{'pitch':-0.6633906,'yaw':21.12,'type': 'info',"cssClass": "custom-hotspot",'text': 'Erste banka','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Erste banka'}},{'pitch':-4.643734,'yaw':-93.6,'type': 'info',"cssClass": "custom-hotspot",'text': 'Ulica Kralja Petra I Karađorđevića','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Ulica Kralja Petra I Karađorđevića'}},{'pitch':-0.6633906,'yaw':-167.04,'type': 'info',"cssClass": "custom-hotspot",'text': 'Glavna raskrsnica','clickHandlerFunc':klik,'clickHandlerArgs':{target:'',text:'Glavna raskrsnica'}}]}
    }
});
}
// function posthover() {
